...
import com.abcbank.controller.ABC_BankRestController;
...
public abstract class BaseWebApplicationContextTests {
    ...
    protected ABC_BankRestController controller;
    ...
    public void initDispatcherServlet() throws Exception{
        ...
        controller = (ABC_BankRestController) applicationContext.getBean("customerRestController");
